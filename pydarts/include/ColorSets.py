...
ColorSet['dark'] = {
    ...
    # Backgrounds
    'bg-global': False,
    'bg-round-nb': (0, 0, 0), #Black
    'bg-round-nb-header': (51, 81, 127), #Blue
    'bg-LOGO': (0, 0, 0), #Black
    'bg-darts-nb': (0, 0, 0), #Black
    'bg-darts-nb-header': (51, 81, 127), #Blue
    'bg-optionslist': (0, 0, 0), #Black
    'bg-optionslist-header': (51, 81, 127), #Blue
...
ColorSet['purple'] = {
    ...
    'menu-selected': (228, 41, 162),
    'menu-shortcut': (228, 41, 162),
    'menu-alternate': (255, 240, 60),
    'menu-ok': (255, 240, 60),
    'menu-warning': (255, 255, 255),
    'menu-ko': (20, 7, 61),
    'menu-item-white': (255, 255, 255),
    'menu-item-black': (0, 0, 0),
    'menu-text-black': (255, 255, 255),
    'menu-text-white': (0, 0, 0),
    'menu-buttons': (0, 0, 0),
    'menu-favorite': (255, 215, 0),
    'menu-border': (255, 255, 255),
    'menu-inactive': (119, 19, 118),
    
    # Game's deczription
    'description-bg': (255, 255, 255),
    'description-text': (0, 0, 0),
    'description-game': (0, 0, 0),
    ...
    'game-player-name': (255, 255, 255),
    'game-alt-headers': (48, 48, 48),
    'game-round': (255, 255, 255),
    'game-title1': (20, 7, 61),
    'game-title2': (255, 255, 255),
    'game-type': (255, 255, 255),
    'game-table': (160, 160, 160),
    'game-text': (255, 255, 255),
    'game-option': (255, 255, 255),
    'game-darts': (160, 160, 160),
    'game-inactive': (119, 119, 118),
    'game-dead': (48, 48, 48),
    'game-grey': (189, 206, 186),
    'game-grey2': (74, 74, 74),
    'game-purple':(140, 108, 161),
    'game-red': (189, 108, 109),
    'game-green': (112, 156, 118),
    'game-blue': (0, 0, 255),
    'game-gold': (255, 215, 0),
    'game-silver': (192, 192, 192),
    'game-bronze': (205, 127, 50),
