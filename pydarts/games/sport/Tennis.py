...
class Game(cgame.Game):
    ...
    def __init__(self, display, game, nb_players, options, config, logs, rpi, dmd, video_player):
        ...
        self.game_is_ok_for_color = False #by Manu
        self.free_launch = False #by Manu ne compte pas la flechette en cours
